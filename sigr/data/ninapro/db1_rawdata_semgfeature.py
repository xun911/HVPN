...
#    feature_extraction_winstride = constant.FEATURE_EXTRACTION_WIN_STRIDE   
 ...
 #   semg_root = '/home/weiwentao/public-2/data/ninapro-db1/data' 
    semg_root = None


    feature_root = ('/data/ninapro-feature/ninapro-db1-var-raw-prepro-lowpass-win-%d-stride-%d/' % (feature_extraction_winlength, 
